#ifndef XNucleoDualDriver_h
#define XNucleoDualDriver_h

#include "Arduino.h"
#include <SPI.h>
#include "dSPINConstants.h"

class XNucleoStepper
{
  public:
    ...
    //  allow that.
    XNucleoStepper(int position, int CSPin, int resetPin, int busyPin);
    XNucleoStepper(int position, int CSPin, int resetPin);
