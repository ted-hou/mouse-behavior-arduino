...
trials_with_rxn, trials_with_train, trials_with_ITI, all_first_licks] = first_lick_grabber_operant_fx(lick_times_by_trial, num_trials)
% 
% Update 7-14-17: FOR 500 ms rxn window - 
% Update 7-21-17: checked again against raster H4 d7
% 
% 
% Copy and paste after running lick_times_by_trial_fx:
%       [f_lick_rxn, f_lick_train_abort, f_lick_operant_no_rew, f_lick_operant_rew, f_lick_ITI, trials_with_rxn, trials_with_train, trials_with_ITI, all_first_licks] = first_lick_grabber_operant_fx(lick_times_by_trial, num_trials);
%   [d7_f_ex1_lick_rxn, d7_f_ex1_lick_train_abort, d7_f_ex1_lick_operant_no_rew, d7_f_ex1_lick_operant_rew, d7_f_ex1_lick_ITI,~,~,~,d7_all_ex1_first_licks] = first_lick_grabber_operant_fx(d7_lick_ex1_times_by_trial, num_trials)
% 
% 
% 
...
rxn_train_abort_range = [cue_on_time + rxn_window, cue_on_time + rxn_window + 0.2]; % these trials were early lick aborts by trains, we will exclude if there was a rxn lick because could still be a rxn or train here, and this will eliminate trains
