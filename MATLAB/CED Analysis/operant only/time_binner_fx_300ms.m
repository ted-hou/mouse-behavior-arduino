...
% 
% UPDATE 7-14-17: For use with 300ms rxn time operant only
...
rxn_time = 500;
buffer = 500;	%realy what the buffer should be is how many ms to exclude from counting operant no rew, thus is rxn+200ms
op_rew_open = 3333;
target_time = 5000;
ITI_time = 7000;
...
% % for debug:
% nbins = 5;
% f_licks = d11_f_ex1_lick_operant_rew;
% % For op rew:
...
% DLS_vbt = d11_DLS_ex1_values_by_trial;%combined_DLS_values_by_trial;
% SNc_vbt = d11_SNc_ex1_values_by_trial;%combined_SNc_values_by_trial;

nbins = 5;
f_licks = d11_f_ex1_lick_operant_no_rew;
% For op no rew:
time_bound_1 = (cue_on_time + buffer)/1000; % this is 500 post cue
