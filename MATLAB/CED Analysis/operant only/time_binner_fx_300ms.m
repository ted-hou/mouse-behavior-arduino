...
% f_licks = f_lick_rxn;
% % For rxn licks:
% time_bound_1 = (cue_on_time)/1000; % this cue
% time_bound_2 = (cue_on_time + rxn_time)/1000; % 500 post cue
% DLS_vbt = DLS_values_by_trial;%combined_DLS_values_by_trial;
% SNc_vbt = SNc_values_by_trial;%combined_SNc_values_by_trial;
% 
% nbins = 5;
...
% % For rxn train licks:
% time_bound_1 = (cue_on_time + rxn_ok)/1000; % this is 300 post cue
% time_bound_2 = (cue_on_time + rxn_ok + buffer)/1000; % this is 500 post cue
% DLS_vbt = DLS_values_by_trial;%combined_DLS_values_by_trial;
% SNc_vbt = SNc_values_by_trial;%combined_SNc_values_by_trial;
