...
% 
% UPDATE 7-14-17: For use with 0ms rxn time operant only
% 
...
% % for debug:
nbins = 5;
f_licks = d16_f_ex1_lick_operant_rew;
% For op rew:
...
DLS_vbt = d16_DLS_ex1_values_by_trial;%combined_DLS_values_by_trial;
SNc_vbt = d16_SNc_ex1_values_by_trial;%combined_SNc_values_by_trial;

% nbins = 5;
% f_licks = d16_f_ex1_lick_operant_no_rew;
% % For op no rew:
