...
%% ITI Licks--------------------------------------------------------------------------------------------------
    ...
    %% The plots:---------------------------------------------------------------------------
        ...
        plot([0,0], [-1,1])
        hold on
        plot(time_array, smooth(ITI_DLS_lick_triggered_ave_ignore_NaN, 50, 'gauss'), 'linewidth', 3)
        xlim(xlimits)
        title(title_DLS)
        ...
        plot([0,0], [-1,1])
        hold on
        plot(time_array, smooth(ITI_SNc_lick_triggered_ave_ignore_NaN, 50, 'gauss'), 'linewidth', 3)
        xlim(xlimits)
        title(title_SNc)
...
%% Link plots:
    linkaxes([ax_rewSNc, ax_rewDLS, ax_rxnDLS, ax_rxnSNc, ax_earlyDLS, ax_earlySNc, ax_ITIDLS, ax_ITISNc],'xy')
...
%% Overlays (not normalized)
    ...
    plot(time_array(pos1:pos2),N_pav_DLS(pos1:pos2), 'linewidth', 3)
    ...
    plot(time_array(pos1:pos2),N_pav_SNc(pos1:pos2), 'linewidth', 3)
    legend(names)
    xlim(range_)
    title('SNc')
    ...
    plot(time_array(pos1:pos2),smooth(N_pav_DLS(pos1:pos2),50,'gauss'), 'linewidth', 3)
    ...
    plot(time_array(pos1:pos2),smooth(N_pav_SNc(pos1:pos2),50,'gauss'), 'linewidth', 3)
    legend(names)
    xlim(range_)
    title('SNc')

    linkaxes([ax_rewSNc, ax_rewDLS, ax_rxnDLS, ax_rxnSNc, ax_earlyDLS, ax_earlySNc, ax_pavDLS, ax_pavSNc,ax1, ax2, ax3, ax4],'xy')
