...
% print(3,'-depsc','-painters','lta_rxn_ex1_h3.eps')
% saveas(3,'lta_rxn_ex1_h3.fig','fig')
% print(6,'-depsc','-painters','lta_opnorew_ex1_h3.eps')
% saveas(6,'lta_opnorew_ex1_h3.fig','fig')
% print(7,'-depsc','-painters','lta_oprew_ex1_h3.eps')
% saveas(7,'lta_oprew_ex1_h3.fig','fig')

% print(8,'-depsc','-painters','lta_overlay_nonorm_wnoise_ex1_h3.eps')
% saveas(8,'lta_overlay_nonorm_wnoise_ex1_h3.fig','fig')
% print(9,'-depsc','-painters','lta_overlay_nonorm_smooth_ex1_h3.eps')
% saveas(9,'lta_overlay_nonorm_smooth_ex1_h3.fig','fig')
