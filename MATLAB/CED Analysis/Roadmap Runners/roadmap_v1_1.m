...
savefilename = [mousename_, '_day', daynum_, '_header', headernum_, '_roadmapv1_1', todaysdate];
...
num_lines = 5;
defaultans = {[mousename_, ' Day ',daynum_, ' Header #', headernum_, '-------------------------------'], ['Data generated on ', todaysdate2, ' using roadmapv1_1 set of functions, which includes plot-to-lick and backfill fxs.'], ['Today was processed as ', exptype_, ' with rxn window = ', num2str(rxnwin_), 'ms.'], ['Excluded trials: ', excluded_trials_{1}], 'Notes:'};
