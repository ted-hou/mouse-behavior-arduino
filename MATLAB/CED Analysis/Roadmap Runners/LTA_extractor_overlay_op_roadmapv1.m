...
%         plot(time_array, gausssmooth(pav_DLS_lick_triggered_ave_ignore_NaN, 50, 'gauss'), 'linewidth', 3)
%         xlim(xlimits)
%         hold on
%         plot([0,0], [min(gausssmooth(pav_DLS_lick_triggered_ave_ignore_NaN, 50, 'gauss'))-0.001, max(gausssmooth(pav_DLS_lick_triggered_ave_ignore_NaN, 50, 'gauss'))+0.001])
%         title(title_DLS)



%         ax_pavSNc = subplot(1,2,2)
%         plot(time_array, gausssmooth(pav_SNc_lick_triggered_ave_ignore_NaN, 50, 'gauss'), 'linewidth', 3)
%         xlim(xlimits)
%         hold on
%         plot([0,0], [min(gausssmooth(pav_SNc_lick_triggered_ave_ignore_NaN, 50, 'gauss'))-0.001, max(gausssmooth(pav_SNc_lick_triggered_ave_ignore_NaN, 50, 'gauss'))+0.001])
%         title(title_SNc)
...
%% Rxn Licks--------------------------------------------------------------------------------------------------
    ...
    %% The plots:---------------------------------------------------------------------------
        ...
        plot([0,0], [-1,1])
        hold on
        plot(time_array, gausssmooth(rxn_DLS_lick_triggered_ave_ignore_NaN, 50, 'gauss'), 'linewidth', 3)
        xlim(xlimits)
        title(title_DLS)
        ...
        plot([0,0], [-1,1])
        hold on
        plot(time_array, gausssmooth(rxn_SNc_lick_triggered_ave_ignore_NaN, 50, 'gauss'), 'linewidth', 3)
        xlim(xlimits)
        title(title_SNc)
...
%% Early Licks--------------------------------------------------------------------------------------------------
    ...
    %% The plots:---------------------------------------------------------------------------
        ...
        plot([0,0], [-1,1])
        hold on
        plot(time_array, gausssmooth(early_DLS_lick_triggered_ave_ignore_NaN, 50, 'gauss'), 'linewidth', 3)
        xlim(xlimits)        
        title(title_DLS)
        ...
        plot([0,0], [-1,1])
        hold on
        plot(time_array, gausssmooth(early_SNc_lick_triggered_ave_ignore_NaN, 50, 'gauss'), 'linewidth', 3)
        xlim(xlimits)
        title(title_SNc)
...
%% Operant Rewarded Licks--------------------------------------------------------------------------------------------------
    ...
    %% The plots:---------------------------------------------------------------------------
        ...
        plot([0,0], [-1,1])
        hold on
        plot(time_array, gausssmooth(rew_DLS_lick_triggered_ave_ignore_NaN, 50, 'gauss'), 'linewidth', 3)
        xlim(xlimits)
        title(title_DLS)
        ...
        plot([0,0], [-1,1])
        hold on
        plot(time_array, gausssmooth(rew_SNc_lick_triggered_ave_ignore_NaN, 50, 'gauss'), 'linewidth', 3)
        xlim(xlimits)
        title(title_SNc)
...
%% ITI Licks--------------------------------------------------------------------------------------------------
    ...
    %% The plots:---------------------------------------------------------------------------
        ...
        plot([0,0], [-1,1])
        hold on
        plot(time_array, gausssmooth(ITI_DLS_lick_triggered_ave_ignore_NaN, 50, 'gauss'), 'linewidth', 3)
        xlim(xlimits)
        title(title_DLS)
        ...
        plot([0,0], [-1,1])
        hold on
        plot(time_array, gausssmooth(ITI_SNc_lick_triggered_ave_ignore_NaN, 50, 'gauss'), 'linewidth', 3)
        xlim(xlimits)
        title(title_SNc)
...
%% Overlays (not normalized)
    ...
    plot([0,0], [-1,1], 'g-', 'linewidth', 2)
    hold on
    plot(time_array(pos1:pos2),gausssmooth(N_rxn_DLS(pos1:pos2),50,'gauss'), 'linewidth', 3)
    plot(time_array(pos1:pos2),gausssmooth(N_early_DLS(pos1:pos2),50,'gauss'), 'linewidth', 3)
    plot(time_array(pos1:pos2),gausssmooth(N_rew_DLS(pos1:pos2),50,'gauss'), 'linewidth', 3)
    % plot(time_array(pos1:pos2),gausssmooth(N_pav_DLS,50,'gauss'), 'linewidth', 3)
    ...
    plot([0,0], [-1,1], 'g-', 'linewidth', 2)
    hold on
    plot(time_array(pos1:pos2),gausssmooth(N_rxn_SNc(pos1:pos2),50,'gauss'), 'linewidth', 3)
    plot(time_array(pos1:pos2),gausssmooth(N_early_SNc(pos1:pos2),50,'gauss'), 'linewidth', 3)
    plot(time_array(pos1:pos2),gausssmooth(N_rew_SNc(pos1:pos2),50,'gauss'), 'linewidth', 3)
    % plot(time_array(pos1:pos2),gausssmooth(N_pav_SNc,50,'gauss'), 'linewidth', 3)
    legend(names)
    xlim(range_)
    title('SNc')
