function [] = LTA_extractor_overlay_op_roadmapv1_COMBO_gausssmoothfx(combined_data_struct)
...
cue = 1501;
% DLS = combined_data_struct.DLS_values_by_trial;
% SNc = combined_data_struct.SNc_values_by_trial;
num_trials = size(combined_data_struct.DLS_values_by_trial,1);
backfilltime = 5000;
...
%     %% DLS Plots---------------------------------------------------------------------------
%         dummy_data = combined_data_struct.DLS_values_by_trial;
%         cue_position = cue;
...
%     %% SNc Plots--------------------------------------------------------------------------------
%         dummy_data = combined_data_struct.SNc_values_by_trial;
%         cue_position = cue;
...
%         plot(time_array, gausssmooth(pav_DLS_lick_triggered_ave_ignore_NaN, smoothwindow, 'gauss'), 'linewidth', 3)
%         xlim(xlimits)
%         hold on
%         plot([0,0], [min(gausssmooth(pav_DLS_lick_triggered_ave_ignore_NaN, smoothwindow, 'gauss'))-0.001, max(gausssmooth(pav_DLS_lick_triggered_ave_ignore_NaN, smoothwindow, 'gauss'))+0.001])
%         title(title_DLS)



%         ax_pavSNc = subplot(1,2,2)
%         plot(time_array, gausssmooth(pav_SNc_lick_triggered_ave_ignore_NaN, smoothwindow, 'gauss'), 'linewidth', 3)
%         xlim(xlimits)
%         hold on
%         plot([0,0], [min(gausssmooth(pav_SNc_lick_triggered_ave_ignore_NaN, smoothwindow, 'gauss'))-0.001, max(gausssmooth(pav_SNc_lick_triggered_ave_ignore_NaN, smoothwindow, 'gauss'))+0.001])
%         title(title_SNc)
...
%% Rxn Licks--------------------------------------------------------------------------------------------------
    dummy_licks = combined_data_struct.f_ex_lick_rxn;
    ...
    %% The plots:---------------------------------------------------------------------------
        ...
        plot([0,0], [-1,1])
        hold on
        plot(time_array, gausssmooth(rxn_DLS_lick_triggered_ave_ignore_NaN, smoothwindow, 'gauss'), 'linewidth', 3)
        xlim(xlimits)
        title(title_DLS)
        ...
        plot([0,0], [-1,1])
        hold on
        plot(time_array, gausssmooth(rxn_SNc_lick_triggered_ave_ignore_NaN, smoothwindow, 'gauss'), 'linewidth', 3)
        xlim(xlimits)
        title(title_SNc)
...
%% Early Licks--------------------------------------------------------------------------------------------------
    dummy_licks = combined_data_struct.f_ex_lick_operant_no_rew;
    ...
    %% The plots:---------------------------------------------------------------------------
        ...
        plot([0,0], [-1,1])
        hold on
        plot(time_array, gausssmooth(early_DLS_lick_triggered_ave_ignore_NaN, smoothwindow, 'gauss'), 'linewidth', 3)
        xlim(xlimits)        
        title(title_DLS)
        ...
        plot([0,0], [-1,1])
        hold on
        plot(time_array, gausssmooth(early_SNc_lick_triggered_ave_ignore_NaN, smoothwindow, 'gauss'), 'linewidth', 3)
        xlim(xlimits)
        title(title_SNc)
...
%% Operant Rewarded Licks--------------------------------------------------------------------------------------------------
    dummy_licks = combined_data_struct.f_ex_lick_operant_rew;
    ...
    %% The plots:---------------------------------------------------------------------------
        ...
        plot([0,0], [-1,1])
        hold on
        plot(time_array, gausssmooth(rew_DLS_lick_triggered_ave_ignore_NaN, smoothwindow, 'gauss'), 'linewidth', 3)
        xlim(xlimits)
        title(title_DLS)
        ...
        plot([0,0], [-1,1])
        hold on
        plot(time_array, gausssmooth(rew_SNc_lick_triggered_ave_ignore_NaN, smoothwindow, 'gauss'), 'linewidth', 3)
        xlim(xlimits)
        title(title_SNc)
...
%% ITI Licks--------------------------------------------------------------------------------------------------
    dummy_licks = combined_data_struct.f_ex_lick_ITI;
    ...
    %% The plots:---------------------------------------------------------------------------
        ...
        plot([0,0], [-1,1])
        hold on
        plot(time_array, gausssmooth(ITI_DLS_lick_triggered_ave_ignore_NaN, smoothwindow, 'gauss'), 'linewidth', 3)
        xlim(xlimits)
        title(title_DLS)
        ...
        plot([0,0], [-1,1])
        hold on
        plot(time_array, gausssmooth(ITI_SNc_lick_triggered_ave_ignore_NaN, smoothwindow, 'gauss'), 'linewidth', 3)
        xlim(xlimits)
        title(title_SNc)
...
%% Overlays (not normalized)
    ...
    plot([0,0], [-1,1], 'g-', 'linewidth', 2)
    hold on
    plot(time_array(pos1:pos2),gausssmooth(N_rxn_DLS(pos1:pos2),smoothwindow,'gauss'), 'linewidth', 3)
    plot(time_array(pos1:pos2),gausssmooth(N_early_DLS(pos1:pos2),smoothwindow,'gauss'), 'linewidth', 3)
    plot(time_array(pos1:pos2),gausssmooth(N_rew_DLS(pos1:pos2),smoothwindow,'gauss'), 'linewidth', 3)
    % plot(time_array(pos1:pos2),gausssmooth(N_pav_DLS,smoothwindow,'gauss'), 'linewidth', 3)
    ...
    plot([0,0], [-1,1], 'g-', 'linewidth', 2)
    hold on
    plot(time_array(pos1:pos2),gausssmooth(N_rxn_SNc(pos1:pos2),smoothwindow,'gauss'), 'linewidth', 3)
    plot(time_array(pos1:pos2),gausssmooth(N_early_SNc(pos1:pos2),smoothwindow,'gauss'), 'linewidth', 3)
    plot(time_array(pos1:pos2),gausssmooth(N_rew_SNc(pos1:pos2),smoothwindow,'gauss'), 'linewidth', 3)
    % plot(time_array(pos1:pos2),gausssmooth(N_pav_SNc,smoothwindow,'gauss'), 'linewidth', 3)
    legend(names)
    xlim(range_)
    title('SNc')
