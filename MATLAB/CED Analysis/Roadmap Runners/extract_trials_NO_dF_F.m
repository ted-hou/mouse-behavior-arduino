%% Extract CED Data using NO dF/F - from 8-1-17 version of extract trials gfit v1 roadmap
%	Created:		6-3-17	ahamilos
%	Last Updated:	9-4-17	ahamilos
%
% Generic for any kind of trial type (hyb, op, etc)
%
% 	9-04-17: no dF/F version
...
h_alert = msgbox('Extracting Trials - no dF/F - Complete');
