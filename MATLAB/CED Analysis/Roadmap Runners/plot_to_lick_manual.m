...
% 
% Created  8-8-17 ahamilos
% Modified 8-8-17 ahamilos
% 
% UPDATE LOG:
% 	-
% 
...
%% DEBUG-----------------------------------
% DLS_vbt = d15_DLS_ex1_values_by_trial_fi_trim;
% SNc_vbt = d15_SNc_ex1_values_by_trial_fi_trim;
DLS_vbt = d15_DLS_ex1_values_by_trial;
SNc_vbt = d15_SNc_ex1_values_by_trial;

all_first_licks = d15_all_ex1_first_licks;
f_ex_lick_rxn = d15_f_ex1_lick_rxn;
f_ex_lick_operant_no_rew = d15_f_ex1_lick_operant_no_rew;
f_ex_lick_operant_rew = d15_f_ex1_lick_operant_rew;
f_ex_lick_ITI = d15_f_ex1_lick_ITI;
time_array = d15_time_array;
early_DLS_lick_triggered_trials = d15_early_DLS_lick_triggered_trials;
rew_DLS_lick_triggered_trials = d15_rew_DLS_lick_triggered_trials;
early_SNc_lick_triggered_trials = d15_early_SNc_lick_triggered_trials;
rew_SNc_lick_triggered_trials = d15_rew_SNc_lick_triggered_trials;
rxnwin_ = 500;
exptype_ = 'op';
%-----------------------------------------
...
% CTA initialization:
	...
	f_licks_rxn = d15_f_ex1_lick_rxn;
	f_licks_early = d15_f_ex1_lick_operant_no_rew;
	f_licks_oprew = d15_f_ex1_lick_operant_rew;
	f_licks_ITI = d15_f_ex1_lick_ITI;
...
%% COMBINED (ALL OPERANTS) CASE------------------------------------------------------------------------------------------
	...
	time_bound_1 = time_bound_1_early; % this is 700 post cue
	time_bound_2 = time_bound_2_rew; % this is 7000 post cue
...
%% ----------------- CTA: plot the aves around peak and trough for each bin:
	...
	for ibins = 1:nbins
		...
		DLS_binpos1 = DLS_minpos(ibins) - 400 + 1500;
		DLS_binpos2 = DLS_minpos(ibins) + 400 + 1500;
		DLS_binpos3 = DLS_maxpos(ibins) - 400 + 1500;
		DLS_binpos4 = DLS_maxpos(ibins) + 400 + 1500;
		SNc_binpos1 = SNc_minpos(ibins) - 400 + 1500;
		SNc_binpos2 = SNc_minpos(ibins) + 400 + 1500;
		SNc_binpos3 = SNc_maxpos(ibins) - 400 + 1500;
		SNc_binpos4 = SNc_maxpos(ibins) + 400 + 1500;
...
% 	for ibins = 1:nbins
% 		
% 		plot((time_array(pos1:pos2)-1500), smooth(DLS_bin_aves{ibins}(pos1:pos2), 50, 'gauss'), 'linewidth', 1);
% 		hold on;
...
% 	plot([xwin], [0,0], 'k-', 'linewidth', 1)
% 	for ibins = 1:nbins
% 		plot(time_array(pos1:pos2), smooth(SNc_bin_aves{ibins}(pos1:pos2), 50, 'gauss'), 'linewidth', 1);
% 		hold on;
% 		% names{ibins+2} = ['Bin # ', num2str(ibins)];
% 	end
% 	legend(names);
...
% 	% plot([cue_on_time+target_time, cue_on_time+target_time], [-1,1], 'r-', 'linewidth', 1)
% 	% for ibins = 1:nbins
% 	% 	plot(smooth(DLS_bin_aves{ibins}, smooth_kernel, 'gauss'), 'linewidth', 1);
% 	% 	hold on;
% 	% end
% 	% legend(names);
% 	% ylim([-1,1])
...
% 	% plot([cue_on_time+target_time, cue_on_time+target_time], [-1,1], 'r-', 'linewidth', 1)
% 	% for ibins = 1:nbins
% 	% 	plot(smooth(SNc_bin_aves{ibins}, smooth_kernel, 'gauss'), 'linewidth', 1);
% 	% 	hold on;
% 	% end
% 	% legend(names);
% 	% ylim([-1,1])
