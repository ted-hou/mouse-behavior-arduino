function [DLS_binned_data, SNc_binned_data,ntrials_per_bin] = trial_binner_fx(all_first_licks, nbins, DLS_values_by_trial, SNc_values_by_trial, lick_times_by_trial)%, DLS_values, SNc_values)
% 
