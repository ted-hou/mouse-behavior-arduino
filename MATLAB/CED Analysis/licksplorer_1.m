...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   ...
   hexclude_trials = uicontrol('Style','pushbutton',...
          ...
          'Position',[.55,.85,button_width1,button_height1/2],...
   ...
   hview_included_trials = uicontrol('Style','pushbutton',...
          ...
          'Position',[.55,.8,button_width1,button_height1/2],...
   ...
   htext2 = uicontrol('Style','text',...
          ...
          'Position',[0.55,0.55,button_width1,button_height1],...
    ...
    %------------------------------------------------------              
       hlistbox = uicontrol('Style','listbox',...
              'units', 'normalized',...
              'Fontsize', 15,...
              'Position',[0.55,0.3,button_width1,.1],...
    ...
    %------------------------------------------------------
       hlb_button = uicontrol('Style','pushbutton',...
              ...
              'Fontsize', 15,...
              'Position',[.55,.28,button_width1,button_height1],...
    ...
    %------------------------------------------------------
       hrename_data_button = uicontrol('Style','pushbutton',...
              ...
              'Fontsize', 15,...
              'Position',[.55,.2,button_width1,button_height1],...
   ...
   haverages = uicontrol('Style','pushbutton',...
          ...
          'Fontsize', 15,...
          'Position',[.55,.25,button_width1,button_height1],...
...
%%
   ...
   function averages_button_Callback(source,eventdata) 
      ...
      SNc_ave = SNc_sum/(num_trials);

      DLS_sum = sum(DLS_values_by_trial,1);
      DLS_ave = DLS_sum/(num_trials);
