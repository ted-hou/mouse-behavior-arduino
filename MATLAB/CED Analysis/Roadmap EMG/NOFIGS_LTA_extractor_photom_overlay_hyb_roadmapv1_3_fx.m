function [rxn_signal_lick_triggered_trials,...
    ...
    N_pav_signal,...
    N_ITI_signal,...
    time_array] = NOFIGS_LTA_extractor_photom_overlay_hyb_roadmap1_3_fx(signal_vbt,num_trials,f_ex_lick_pavlovian,f_ex_lick_rxn,f_ex_lick_operant_no_rew,f_ex_lick_operant_rew,f_ex_lick_ITI, signalname)
...
% 
% 
% Created  ahamilos 7-20-17 (from +Figures version)
% Modified ahamilos 12-5-17 -- no plots
% 
% 
% SMOOTH = 50 ms gauss
% 
