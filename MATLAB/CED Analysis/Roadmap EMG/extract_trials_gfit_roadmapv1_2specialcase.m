...
%
% 
% ONLY USE WITH B4 DAY 1 because of recording error that throws off
% analysis otherwise
% 
% 
...
[X_times_by_trial, X_values_by_trial] = special_case_day1_extract(X_times,...
																					 X_values,...
																					 trial_start_times,...
																					 cue_on_times,...
																					 100);
[Y_times_by_trial, Y_values_by_trial] = special_case_day1_extract(Y_times,...
																					 Y_values,...
																					 trial_start_times,...
																					 cue_on_times,...
																					 100);
[Z_times_by_trial, Z_values_by_trial] = special_case_day1_extract(Z_times,...
																					 Z_values,...
																					 trial_start_times,...
																					 cue_on_times,...
																					 100);
[EMG_times_by_trial, EMG_values_by_trial] = special_case_day1_extract(EMG_times,...
																					 EMG_values,...
																					 trial_start_times,...
																					 cue_on_times,...
																					 100);
