...
%	Last Updated:	11-29-17	ahamilos
%
% Generic for any kind of trial type (hyb, op, etc)
%
%   11-29-17: modified so all signals use the
%       put_move_data_into_trials_aligned_to_cue_on using the p_Hz_ and m_Hz_
%       UI
...
if dls_on == 1
    [DLS_times_by_trial, DLS_values_by_trial] = put_move_data_into_trials_aligned_to_cue_on_fx_roadmapv1_2(DLS_times,...
																					 gfit_DLS,...
																					 trial_start_times,...
																					 cue_on_times,...
                                                                                     str2num(p_Hz_),...
...
if snc_on == 1
    [SNc_times_by_trial, SNc_values_by_trial] = put_move_data_into_trials_aligned_to_cue_on_fx_roadmapv1_2(SNc_times,...
																					 gfit_SNc,...
																					 trial_start_times,...
																					 cue_on_times,...
                                                                                     str2num(p_Hz_),...
...
if vta_on == 1
    [VTA_times_by_trial, VTA_values_by_trial] = put_move_data_into_trials_aligned_to_cue_on_fx_roadmapv1_2(VTA_times,...
																					 gfit_VTA,...
																					 trial_start_times,...
																					 cue_on_times,...
                                                                                     str2num(p_Hz_),...
...
if dlsred_on == 1
    [DLSred_times_by_trial, DLSred_values_by_trial] = put_move_data_into_trials_aligned_to_cue_on_fx_roadmapv1_2(DLSred_times,...
																					 gfit_DLSred,...
																					 trial_start_times,...
																					 cue_on_times,...
                                                                                     str2num(p_Hz_),...
...
if sncred_on == 1
    [SNcred_times_by_trial, SNcred_values_by_trial] = put_move_data_into_trials_aligned_to_cue_on_fx_roadmapv1_2(SNcred_times,...
																					 gfit_SNcred,...
																					 trial_start_times,...
																					 cue_on_times,...
                                                                                     str2num(p_Hz_),...
...
if vtared_on == 1
    [VTAred_times_by_trial, VTAred_values_by_trial] = put_move_data_into_trials_aligned_to_cue_on_fx_roadmapv1_2(VTAred_times,...
																					 gfit_VTAred,...
																					 trial_start_times,...
																					 cue_on_times,...
                                                                                     str2num(p_Hz_),...
