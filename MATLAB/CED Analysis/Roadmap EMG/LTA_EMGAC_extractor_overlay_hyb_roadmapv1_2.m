...
% 
% 
% Created  ahamilos 7-20-17 (from LTA_extractor_overlay_hyb_roadmapv1.m)
% Modified ahamilos 9-25-17
% 
% 
% SMOOTH = 50 ms gauss
% 
...
% *********************)
%  (replace all DMS with X, all SNc with EMG
% 
% 
%  Update Log:
%       9-25-17: Modified for EMG/acc data (sampling rate now variable)
...
% Pavlovian Licks (comment out for op only)--------------------------------------------------------------------------------------------------
    ...
    title_X = 'X pavlovian licks';
    title_Y = 'Y pavlovian licks'; %************************
    title_Z = 'Z pavlovian licks'; %************************
    title_EMG = 'EMG pavlovian licks';
    xlimits = range_;
   ...
   %% Variables to save:
    pav_X_lick_triggered_trials = X_lick_triggered_trials;
    pav_Y_lick_triggered_trials = Y_lick_triggered_trials;%***********************
    pav_Z_lick_triggered_trials = Z_lick_triggered_trials; %***********************
    pav_EMG_lick_triggered_trials = EMG_lick_triggered_trials;
    
    pav_X_lick_triggered_ave_ignore_NaN = X_lick_triggered_ave_ignore_NaN;
    pav_Y_lick_triggered_ave_ignore_NaN = Y_lick_triggered_ave_ignore_NaN;%***********************
    pav_Z_lick_triggered_ave_ignore_NaN = Z_lick_triggered_ave_ignore_NaN;%***********************
    pav_EMG_lick_triggered_ave_ignore_NaN = EMG_lick_triggered_ave_ignore_NaN;
    %% The plots:---------------------------------------------------------------------------
        figure
        ax_pavX = subplot(1,4,1) %***********************
        plot([0,0], [1,2])
        hold on
        plot(time_array, gausssmooth(pav_X_lick_triggered_ave_ignore_NaN, smoothwin, 'gauss'), 'linewidth', 3)
        xlim(xlimits)
        title(title_X)

        ax_pavY = subplot(1,4,2) %***********************
        plot([0,0], [1,2])
        hold on
        plot(time_array, gausssmooth(pav_Y_lick_triggered_ave_ignore_NaN, smoothwin, 'gauss'), 'linewidth', 3)%***********************
        xlim(xlimits)
        title(title_Y)%***********************

        ax_pavZ = subplot(1,4,3) %***********************
        plot([0,0], [1,2])
        hold on
        plot(time_array, gausssmooth(pav_Z_lick_triggered_ave_ignore_NaN, smoothwin, 'gauss'), 'linewidth', 3)%***********************
        xlim(xlimits)
        title(title_Z)%***********************



        ax_pavEMG = subplot(1,4,4) %***********************
        plot([0,0], [-1,1])
        hold on
        plot(time_array, gausssmooth(pav_EMG_lick_triggered_ave_ignore_NaN, smoothwin, 'gauss'), 'linewidth', 3)
        xlim(xlimits)
        title(title_EMG)
...
%% Link plots:
    linkaxes([ax_rewEMG, ax_rxnEMG, ax_earlyEMG, ax_ITIEMG, ax_rewX, ax_rxnX, ax_earlyX, ax_ITIX], 'off') %***********************
    linkaxes([ax_rxnX, ax_earlyX, ax_rewX,ax_pavX, ax_ITIX],'xy') %***********************
    linkaxes([ax_rxnY, ax_earlyY, ax_rewY,ax_pavY, ax_ITIY],'xy') %***********************
    linkaxes([ax_rxnZ, ax_earlyZ, ax_rewZ,ax_pavZ, ax_ITIZ],'xy') %***********************
    linkaxes([ax_rxnEMG, ax_earlyEMG, ax_rewEMG,ax_pavEMG, ax_ITIEMG],'xy') %***********************
...
%% Overlays (not normalized)
    ...
    N_pav_X = pav_X_lick_triggered_ave_ignore_NaN;
    N_pav_Y = pav_Y_lick_triggered_ave_ignore_NaN; %***********************
    N_pav_Z = pav_Z_lick_triggered_ave_ignore_NaN; %***********************
    N_pav_EMG = pav_EMG_lick_triggered_ave_ignore_NaN;
