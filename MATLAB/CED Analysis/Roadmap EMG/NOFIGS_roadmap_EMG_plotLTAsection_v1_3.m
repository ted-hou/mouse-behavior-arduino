...
% --------------------------------------------------------------------------------
	...
	lick_triggered_trials_struct.DLS_lick_triggered_trials.Ave_rxn_DLS = [];
	lick_triggered_trials_struct.DLS_lick_triggered_trials.Ave_early_DLS = [];
	lick_triggered_trials_struct.DLS_lick_triggered_trials.Ave_rew_DLS = [];
	lick_triggered_trials_struct.DLS_lick_triggered_trials.Ave_ITI_DLS = [];
	lick_triggered_trials_struct.DLS_lick_triggered_trials.Ave_pav_DLS = [];
	...
	lick_triggered_trials_struct.SNc_lick_triggered_trials.Ave_rxn_SNc = [];
	lick_triggered_trials_struct.SNc_lick_triggered_trials.Ave_early_SNc = [];
	lick_triggered_trials_struct.SNc_lick_triggered_trials.Ave_rew_SNc = [];
	lick_triggered_trials_struct.SNc_lick_triggered_trials.Ave_ITI_SNc = [];
	lick_triggered_trials_struct.SNc_lick_triggered_trials.Ave_pav_SNc = [];
	...
	lick_triggered_trials_struct.VTA_lick_triggered_trials.Ave_rxn_VTA = [];
	lick_triggered_trials_struct.VTA_lick_triggered_trials.Ave_early_VTA = [];
	lick_triggered_trials_struct.VTA_lick_triggered_trials.Ave_rew_VTA = [];
	lick_triggered_trials_struct.VTA_lick_triggered_trials.Ave_ITI_VTA = [];
	lick_triggered_trials_struct.VTA_lick_triggered_trials.Ave_pav_VTA = [];
	...
	lick_triggered_trials_struct.DLSred_lick_triggered_trials.Ave_rxn_DLSred = [];
	lick_triggered_trials_struct.DLSred_lick_triggered_trials.Ave_early_DLSred = [];
	lick_triggered_trials_struct.DLSred_lick_triggered_trials.Ave_rew_DLSred = [];
	lick_triggered_trials_struct.DLSred_lick_triggered_trials.Ave_ITI_DLSred = [];
	lick_triggered_trials_struct.DLSred_lick_triggered_trials.Ave_pav_DLSred = [];
	...
	lick_triggered_trials_struct.SNcred_lick_triggered_trials.Ave_rxn_SNcred = [];
	lick_triggered_trials_struct.SNcred_lick_triggered_trials.Ave_early_SNcred = [];
	lick_triggered_trials_struct.SNcred_lick_triggered_trials.Ave_rew_SNcred = [];
	lick_triggered_trials_struct.SNcred_lick_triggered_trials.Ave_ITI_SNcred = [];
	lick_triggered_trials_struct.SNcred_lick_triggered_trials.Ave_pav_SNcred = [];
	...
	lick_triggered_trials_struct.VTAred_lick_triggered_trials.Ave_rxn_VTAred = [];
	lick_triggered_trials_struct.VTAred_lick_triggered_trials.Ave_early_VTAred = [];
	lick_triggered_trials_struct.VTAred_lick_triggered_trials.Ave_rew_VTAred = [];
	lick_triggered_trials_struct.VTAred_lick_triggered_trials.Ave_ITI_VTAred = [];
	lick_triggered_trials_struct.VTAred_lick_triggered_trials.Ave_pav_VTAred = [];
	...
	lick_triggered_trials_struct.X_lick_triggered_trials.Ave_rxn_X = [];
	lick_triggered_trials_struct.X_lick_triggered_trials.Ave_early_X = [];
	lick_triggered_trials_struct.X_lick_triggered_trials.Ave_rew_X = [];
	lick_triggered_trials_struct.X_lick_triggered_trials.Ave_ITI_X = [];
	lick_triggered_trials_struct.X_lick_triggered_trials.Ave_pav_X = [];
	...
	lick_triggered_trials_struct.Y_lick_triggered_trials.Ave_rxn_Y = [];
	lick_triggered_trials_struct.Y_lick_triggered_trials.Ave_early_Y = [];
	lick_triggered_trials_struct.Y_lick_triggered_trials.Ave_rew_Y = [];
	lick_triggered_trials_struct.Y_lick_triggered_trials.Ave_ITI_Y = [];
	lick_triggered_trials_struct.Y_lick_triggered_trials.Ave_pav_Y = [];
	...
	lick_triggered_trials_struct.Z_lick_triggered_trials.Ave_rxn_Z = [];
	lick_triggered_trials_struct.Z_lick_triggered_trials.Ave_early_Z = [];
	lick_triggered_trials_struct.Z_lick_triggered_trials.Ave_rew_Z = [];
	lick_triggered_trials_struct.Z_lick_triggered_trials.Ave_ITI_Z = [];
	lick_triggered_trials_struct.Z_lick_triggered_trials.Ave_pav_Z = [];
	...
	lick_triggered_trials_struct.EMG_lick_triggered_trials.Ave_rxn_EMG = [];
	lick_triggered_trials_struct.EMG_lick_triggered_trials.Ave_early_EMG = [];
	lick_triggered_trials_struct.EMG_lick_triggered_trials.Ave_rew_EMG = [];
	lick_triggered_trials_struct.EMG_lick_triggered_trials.Ave_ITI_EMG = [];
	lick_triggered_trials_struct.EMG_lick_triggered_trials.Ave_pav_EMG = [];
	...
	if snc_on 
		...
		if strcmp(exptype_,'hyb')
			...
			% %% Save all figures:
			% figure_counter = figure_counter+1;	
			% print(figure_counter,'-depsc','-painters', ['LTA_RXAve_ex', exclusion_criteria_version_, '_header', headernum_, '__', todaysdate, '_', mousename_ '.eps'])
			% saveas(figure_counter,['LTA_RXAve_ex', exclusion_criteria_version_, '_header', headernum_, '__', todaysdate, '_', mousename_ '.fig'],'fig')
			% figure_counter = figure_counter+1;	
		...
		elseif strcmp(exptype_, 'op')
    		...
    		lick_triggered_trials_struct.SNc_lick_triggered_trials.Ave_rew_SNc,...
    		lick_triggered_trials_struct.SNc_lick_triggered_trials.Ave_ITI_SNc,...
    		time_array_1000hz] = NOFIGS_LTA_extractor_photom_overlay_op_roadmapv1_3_fx(SNc_values_by_trial,num_trials,f_ex_lick_rxn,f_ex_lick_operant_no_rew,f_ex_lick_operant_rew,f_ex_lick_ITI, signalname);
			...
			% figure_counter = figure_counter+1;
			% print(figure_counter,'-depsc','-painters', ['SNc_LTA_RXAve_ex', exclusion_criteria_version_, '_header', headernum_, '__', todaysdate, '_', mousename_ '.eps'])
			% saveas(figure_counter,['SNc_LTA_RXAve_ex', exclusion_criteria_version_, '_header', headernum_, '__', todaysdate, '_', mousename_ '.fig'],'fig')
			% figure_counter = figure_counter+1;
	...
	if dls_on 
			...
			if strcmp(exptype_,'hyb')
	    		...
	    		lick_triggered_trials_struct.DLS_lick_triggered_trials.Ave_pav_DLS,...
	    		lick_triggered_trials_struct.DLS_lick_triggered_trials.Ave_ITI_DLS,...
	    		time_array_1000hz] = NOFIGS_LTA_extractor_photom_overlay_hyb_roadmap1_3_fx(DLS_values_by_trial,num_trials,f_ex_lick_pavlovian,f_ex_lick_rxn,f_ex_lick_operant_no_rew,f_ex_lick_operant_rew,f_ex_lick_ITI, signalname);
			...
			elseif strcmp(exptype_, 'op')
	    		...
	    		lick_triggered_trials_struct.DLS_lick_triggered_trials.Ave_rew_DLS,...
	    		lick_triggered_trials_struct.DLS_lick_triggered_trials.Ave_ITI_DLS,...
	    		time_array_1000hz] = NOFIGS_LTA_extractor_photom_overlay_op_roadmapv1_3_fx(DLS_values_by_trial,num_trials,f_ex_lick_rxn,f_ex_lick_operant_no_rew,f_ex_lick_operant_rew,f_ex_lick_ITI, signalname);
				...
				% figure_counter = figure_counter+1;
				% print(figure_counter,'-depsc','-painters', ['DLS_LTA_RXAve_ex', exclusion_criteria_version_, '_header', headernum_, '__', todaysdate, '_', mousename_ '.eps'])
				% saveas(figure_counter,['DLS_LTA_RXAve_ex', exclusion_criteria_version_, '_header', headernum_, '__', todaysdate, '_', mousename_ '.fig'],'fig')
				% figure_counter = figure_counter+1;
	...
	if vta_on 
			...
			if strcmp(exptype_,'hyb')
	    		...
	    		lick_triggered_trials_struct.VTA_lick_triggered_trials.Ave_pav_VTA,...
	    		lick_triggered_trials_struct.VTA_lick_triggered_trials.Ave_ITI_VTA,...
	    		time_array_1000hz] = NOFIGS_LTA_extractor_photom_overlay_hyb_roadmap1_3_fx(VTA_values_by_trial,num_trials,f_ex_lick_pavlovian,f_ex_lick_rxn,f_ex_lick_operant_no_rew,f_ex_lick_operant_rew,f_ex_lick_ITI, signalname);
			...
			elseif strcmp(exptype_, 'op')
	    		...
	    		lick_triggered_trials_struct.VTA_lick_triggered_trials.Ave_rew_VTA,...
	    		lick_triggered_trials_struct.VTA_lick_triggered_trials.Ave_ITI_VTA,...
	    		time_array_1000hz] = NOFIGS_LTA_extractor_photom_overlay_op_roadmapv1_3_fx(VTA_values_by_trial,num_trials,f_ex_lick_rxn,f_ex_lick_operant_no_rew,f_ex_lick_operant_rew,f_ex_lick_ITI, signalname);
				...
				% figure_counter = figure_counter+1;
				% print(figure_counter,'-depsc','-painters', ['VTA_LTA_RXAve_ex', exclusion_criteria_version_, '_header', headernum_, '__', todaysdate, '_', mousename_ '.eps'])
				% saveas(figure_counter,['VTA_LTA_RXAve_ex', exclusion_criteria_version_, '_header', headernum_, '__', todaysdate, '_', mousename_ '.fig'],'fig')
				% figure_counter = figure_counter+1;
	...
	if sncred_on 
			...
			if strcmp(exptype_,'hyb')
	    		...
	    		lick_triggered_trials_struct.SNcred_lick_triggered_trials.Ave_pav_SNcred,...
	    		lick_triggered_trials_struct.SNcred_lick_triggered_trials.Ave_ITI_SNcred,...
	    		time_array_1000hz] = NOFIGS_LTA_extractor_photom_overlay_hyb_roadmap1_3_fx(SNcred_values_by_trial,num_trials,f_ex_lick_pavlovian,f_ex_lick_rxn,f_ex_lick_operant_no_rew,f_ex_lick_operant_rew,f_ex_lick_ITI, signalname);
			...
			elseif strcmp(exptype_, 'op')
	    		...
	    		lick_triggered_trials_struct.SNcred_lick_triggered_trials.Ave_rew_SNcred,...
	    		lick_triggered_trials_struct.SNcred_lick_triggered_trials.Ave_ITI_SNcred,...
	    		time_array_1000hz] = NOFIGS_LTA_extractor_photom_overlay_op_roadmapv1_3_fx(SNcred_values_by_trial,num_trials,f_ex_lick_rxn,f_ex_lick_operant_no_rew,f_ex_lick_operant_rew,f_ex_lick_ITI, signalname);
				...
				% figure_counter = figure_counter+1;
				% print(figure_counter,'-depsc','-painters', ['SNcred_LTA_RXAve_ex', exclusion_criteria_version_, '_header', headernum_, '__', todaysdate, '_', mousename_ '.eps'])
				% saveas(figure_counter,['SNcred_LTA_RXAve_ex', exclusion_criteria_version_, '_header', headernum_, '__', todaysdate, '_', mousename_ '.fig'],'fig')
				% figure_counter = figure_counter+1;
	...
	if dlsred_on 
			...
			if strcmp(exptype_,'hyb')
	    		...
	    		lick_triggered_trials_struct.DLSred_lick_triggered_trials.Ave_pav_DLSred,...
	    		lick_triggered_trials_struct.DLSred_lick_triggered_trials.Ave_ITI_DLSred,...
	    		time_array_1000hz] = NOFIGS_LTA_extractor_photom_overlay_hyb_roadmap1_3_fx(DLSred_values_by_trial,num_trials,f_ex_lick_pavlovian,f_ex_lick_rxn,f_ex_lick_operant_no_rew,f_ex_lick_operant_rew,f_ex_lick_ITI, signalname);
			...
			elseif strcmp(exptype_, 'op')
	    		...
	    		lick_triggered_trials_struct.DLSred_lick_triggered_trials.Ave_rew_DLSred,...
	    		lick_triggered_trials_struct.DLSred_lick_triggered_trials.Ave_ITI_DLSred,...
	    		time_array_1000hz] = NOFIGS_LTA_extractor_photom_overlay_op_roadmapv1_3_fx(DLSred_values_by_trial,num_trials,f_ex_lick_rxn,f_ex_lick_operant_no_rew,f_ex_lick_operant_rew,f_ex_lick_ITI, signalname);
				...
				% figure_counter = figure_counter+1;
				% print(figure_counter,'-depsc','-painters', ['DLSred_LTA_RXAve_ex', exclusion_criteria_version_, '_header', headernum_, '__', todaysdate, '_', mousename_ '.eps'])
				% saveas(figure_counter,['DLSred_LTA_RXAve_ex', exclusion_criteria_version_, '_header', headernum_, '__', todaysdate, '_', mousename_ '.fig'],'fig')
				% figure_counter = figure_counter+1;
	...
	if vtared_on 
			...
			if strcmp(exptype_,'hyb')
	    		...
	    		lick_triggered_trials_struct.VTAred_lick_triggered_trials.Ave_pav_VTAred,...
	    		lick_triggered_trials_struct.VTAred_lick_triggered_trials.Ave_ITI_VTAred,...
	    		time_array_1000hz] = NOFIGS_LTA_extractor_photom_overlay_hyb_roadmapv1_3_fx(VTAred_values_by_trial,num_trials,f_ex_lick_pavlovian,f_ex_lick_rxn,f_ex_lick_operant_no_rew,f_ex_lick_operant_rew,f_ex_lick_ITI, signalname);
			...
			elseif strcmp(exptype_, 'op')
	    		...
	    		lick_triggered_trials_struct.VTAred_lick_triggered_trials.Ave_rew_VTAred,...
	    		lick_triggered_trials_struct.VTAred_lick_triggered_trials.Ave_ITI_VTAred,...
	    		time_array_1000hz] = NOFIGS_LTA_extractor_photom_overlay_op_roadmapv1_3_fx(VTAred_values_by_trial,num_trials,f_ex_lick_rxn,f_ex_lick_operant_no_rew,f_ex_lick_operant_rew,f_ex_lick_ITI, signalname);
				...
				% figure_counter = figure_counter+1;
				% print(figure_counter,'-depsc','-painters', ['VTAred_LTA_RXAve_ex', exclusion_criteria_version_, '_header', headernum_, '__', todaysdate, '_', mousename_ '.eps'])
				% saveas(figure_counter,['VTAred_LTA_RXAve_ex', exclusion_criteria_version_, '_header', headernum_, '__', todaysdate, '_', mousename_ '.fig'],'fig')
				% figure_counter = figure_counter+1;
	...
	if x_on 
		...
		if strcmp(exptype_,'hyb')
			[lick_triggered_trials_struct.X_lick_triggered_trials.rxn_X_lick_triggered_trials,...
	    		...
	    		lick_triggered_trials_struct.X_lick_triggered_trials.Ave_pav_X,...
	    		lick_triggered_trials_struct.X_lick_triggered_trials.Ave_ITI_X,...
	    		time_array_2000hz] = NOFIGS_LTA_EMGAC_extractor_overlay_hyb_roadmapv1_3_fx(X_values_by_trial,num_trials,f_ex_lick_pavlovian,f_ex_lick_rxn,f_ex_lick_operant_no_rew,f_ex_lick_operant_rew,f_ex_lick_ITI, signalname);
...
% 			%% Save all figures:
% 			figure_counter = figure_counter+1;
% 			print(figure_counter,'-depsc','-painters', ['X_LTA_RXAve_ex', exclusion_criteria_version_, '_header', headernum_, '__', todaysdate, '_', mousename_ '.eps'])
% 			saveas(figure_counter,['X_LTA_RXAve_ex', exclusion_criteria_version_, '_header', headernum_, '__', todaysdate, '_', mousename_ '.fig'],'fig')
% 			figure_counter = figure_counter+1;
...
% 			saveas(figure_counter,['X_LTA_ITI_ex', exclusion_criteria_version_, '_header', headernum_, '__', todaysdate, '_', mousename_ '.fig'],'fig')
		...
		elseif strcmp(exptype_, 'op')
			[lick_triggered_trials_struct.X_lick_triggered_trials.rxn_X_lick_triggered_trials,...
	    		...
	    		lick_triggered_trials_struct.X_lick_triggered_trials.Ave_rew_X,...
	    		lick_triggered_trials_struct.X_lick_triggered_trials.Ave_ITI_X,...
	    		time_array_2000hz] = NOFIGS_LTA_EMGAC_extractor_overlay_op_roadmapv1_3_fx(X_values_by_trial,num_trials,f_ex_lick_rxn,f_ex_lick_operant_no_rew,f_ex_lick_operant_rew,f_ex_lick_ITI, signalname);
	...
	if y_on 
		...
		if strcmp(exptype_,'hyb')
			[lick_triggered_trials_struct.Y_lick_triggered_trials.rxn_Y_lick_triggered_trials,...
	    		...
	    		lick_triggered_trials_struct.Y_lick_triggered_trials.Ave_pav_Y,...
	    		lick_triggered_trials_struct.Y_lick_triggered_trials.Ave_ITI_Y,...
	    		time_array_2000hz] = NOFIGS_LTA_EMGAC_extractor_overlay_hyb_roadmapv1_3_fx(Y_values_by_trial,num_trials,f_ex_lick_pavlovian,f_ex_lick_rxn,f_ex_lick_operant_no_rew,f_ex_lick_operant_rew,f_ex_lick_ITI, signalname);
			...
			% %% Save all figures:
			% figure_counter = figure_counter+1;
			% print(figure_counter,'-depsc','-painters', ['Y_LTA_RYAve_ex', exclusion_criteria_version_, '_header', headernum_, '__', todaysdate, '_', mousename_ '.eps'])
			% saveas(figure_counter,['Y_LTA_RYAve_ex', exclusion_criteria_version_, '_header', headernum_, '__', todaysdate, '_', mousename_ '.fig'],'fig')
			% figure_counter = figure_counter+1;
		...
		elseif strcmp(exptype_, 'op')
			[lick_triggered_trials_struct.Y_lick_triggered_trials.rxn_Y_lick_triggered_trials,...
	    		...
	    		lick_triggered_trials_struct.Y_lick_triggered_trials.Ave_rew_Y,...
	    		lick_triggered_trials_struct.Y_lick_triggered_trials.Ave_ITI_Y,...
	    		time_array_2000hz] = NOFIGS_LTA_EMGAC_extractor_overlay_op_roadmapv1_3_fx(Y_values_by_trial,num_trials,f_ex_lick_rxn,f_ex_lick_operant_no_rew,f_ex_lick_operant_rew,f_ex_lick_ITI, signalname);
	...
	if z_on 
		...
		if strcmp(exptype_,'hyb')
			[lick_triggered_trials_struct.Z_lick_triggered_trials.rxn_Z_lick_triggered_trials,...
	    		...
	    		lick_triggered_trials_struct.Z_lick_triggered_trials.Ave_pav_Z,...
	    		lick_triggered_trials_struct.Z_lick_triggered_trials.Ave_ITI_Z,...
	    		time_array_2000hz] = NOFIGS_LTA_EMGAC_extractor_overlay_hyb_roadmapv1_3_fx(Z_values_by_trial,num_trials,f_ex_lick_pavlovian,f_ex_lick_rxn,f_ex_lick_operant_no_rew,f_ex_lick_operant_rew,f_ex_lick_ITI, signalname);
			...
			% %% Save all figures:
			% figure_counter = figure_counter+1;
			% print(figure_counter,'-depsc','-painters', ['Z_LTA_RZAve_ex', exclusion_criteria_version_, '_header', headernum_, '__', todaysdate, '_', mousename_ '.eps'])
			% saveas(figure_counter,['Z_LTA_RZAve_ex', exclusion_criteria_version_, '_header', headernum_, '__', todaysdate, '_', mousename_ '.fig'],'fig')
			% figure_counter = figure_counter+1;
		...
		elseif strcmp(exptype_, 'op')
			[lick_triggered_trials_struct.Z_lick_triggered_trials.rxn_Z_lick_triggered_trials,...
	    		...
	    		lick_triggered_trials_struct.Z_lick_triggered_trials.Ave_rew_Z,...
	    		lick_triggered_trials_struct.Z_lick_triggered_trials.Ave_ITI_Z,...
	    		time_array_2000hz] = NOFIGS_LTA_EMGAC_extractor_overlay_op_roadmapv1_3_fx(Z_values_by_trial,num_trials,f_ex_lick_rxn,f_ex_lick_operant_no_rew,f_ex_lick_operant_rew,f_ex_lick_ITI, signalname);
	...
	if emg_on 
		...
		if strcmp(exptype_,'hyb')
			[lick_triggered_trials_struct.EMG_lick_triggered_trials.rxn_EMG_lick_triggered_trials,...
	    		...
	    		lick_triggered_trials_struct.EMG_lick_triggered_trials.Ave_pav_EMG,...
	    		lick_triggered_trials_struct.EMG_lick_triggered_trials.Ave_ITI_EMG,...
	    		time_array_2000hz] = NOFIGS_LTA_EMGAC_extractor_overlay_hyb_roadmapv1_3_fx(abs(EMG_values_by_trial),num_trials,f_ex_lick_pavlovian,f_ex_lick_rxn,f_ex_lick_operant_no_rew,f_ex_lick_operant_rew,f_ex_lick_ITI, signalname);
			...
			% %% Save all figures:
			% figure_counter = figure_counter+1;
			% print(figure_counter,'-depsc','-painters', ['EMG_LTA_REMGAve_ex', exclusion_criteria_version_, '_header', headernum_, '__', todaysdate, '_', mousename_ '.eps'])
			% saveas(figure_counter,['EMG_LTA_REMGAve_ex', exclusion_criteria_version_, '_header', headernum_, '__', todaysdate, '_', mousename_ '.fig'],'fig')
			% figure_counter = figure_counter+1;
		...
		elseif strcmp(exptype_, 'op')
			[lick_triggered_trials_struct.EMG_lick_triggered_trials.rxn_EMG_lick_triggered_trials,...
	    		...
	    		lick_triggered_trials_struct.EMG_lick_triggered_trials.Ave_rew_EMG,...
	    		lick_triggered_trials_struct.EMG_lick_triggered_trials.Ave_ITI_EMG,...
	    		time_array_2000hz] = NOFIGS_LTA_EMGAC_extractor_overlay_op_roadmapv1_3_fx(abs(EMG_values_by_trial),num_trials,f_ex_lick_rxn,f_ex_lick_operant_no_rew,f_ex_lick_operant_rew,f_ex_lick_ITI, signalname);
