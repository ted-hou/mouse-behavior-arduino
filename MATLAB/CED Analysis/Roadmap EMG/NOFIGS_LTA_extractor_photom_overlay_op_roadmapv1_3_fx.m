function [rxn_signal_lick_triggered_trials,...
    ...
    N_rew_signal,...
    N_ITI_signal,...
    time_array] = NOFIGS_LTA_extractor_photom_overlay_op_roadmap1_3_fx(signal_vbt,num_trials,f_ex_lick_rxn,f_ex_lick_operant_no_rew,f_ex_lick_operant_rew,f_ex_lick_ITI, signalname)

% NOTE! Input signal_vbt NOT THE EXCLUDED VERSION!
...
%% Rxn Licks--------------------------------------------------------------------------------------------------
    ...
    %% Signal Plots---------------------------------------------------------------------------
        ...
        for i_trial = 1:num_trials
            if find(dummy_data(i_trial, :) > -1000000)
