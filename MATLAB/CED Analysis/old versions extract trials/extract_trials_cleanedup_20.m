...
plot(SNc_ave)
hold on
plot([1500, 1500], [0,1], 'r-')
plot([6500, 6500], [0,1], 'r-')
xlim([0,18500])
ylim([0.516,.528])
title('SNc Average Across Trials')
...
xlim([0,18500])
ylim([.505,.545])
title('SNc OPERANT Average Across Trials')

subplot(2,2,2)
plot(SNc_ave_NOToperant)
hold on
plot([1500, 1500], [0,1], 'r-')
hold on
plot([6500, 6500], [0,1], 'r-')
...
xlim([0,18500])
ylim([.505,.545])
title('SNc NOT OPERANT Average Across Trials')

subplot(2,2,3)
plot(DLS_ave_operant)
hold on
plot([1500, 1500], [0,1], 'r-')
hold on
plot([6500, 6500], [0,1], 'r-')
xlim([0,18500])
ylim([.2,.22])
title('DLS OPERANT Average Across Trials')

subplot(2,2,4)
plot(DLS_ave_NOToperant)
hold on
plot([1500, 1500], [0,1], 'r-')
hold on
plot([6500, 6500], [0,1], 'r-')
xlim([0,18500])
ylim([.2,.22])
title('DLS NOT OPERANT Average Across Trials')
