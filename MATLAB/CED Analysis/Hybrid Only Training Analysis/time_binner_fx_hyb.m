...
% 	last modified 6-30-17 ahamilos
% 
% 	Dependencies:
...
nbins = 5;
f_licks = d3_f_ex1_lick_operant_no_rew;
% For op rew:
...
DLS_vbt = d3_DLS_ex1_values_by_trial;%combined_DLS_values_by_trial;
SNc_vbt = d3_SNc_ex1_values_by_trial;%combined_SNc_values_by_trial;
...
for ibin = 1:nbins
	...
	for itrial = 1:DLS_ntrials_bin-1 %%%%%%%%%%%% not sure why this -1 needed, go back and check
...
for ibin = 1:nbins+1
	...
	for itrial = 1:SNc_ntrials_bin-1 %%%%%%%%%%%% not sure why this -1 needed, go back and check
...
% Now plot the median value: (need to go back and add handles to the plots 
