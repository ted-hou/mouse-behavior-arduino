...
subplot(5,1,5);
histogram([hybrid_times_1st_post_cue_lick, hybrid_times_1st_lick_no_lick_period, pre_hybrid_times_1st_lick_reward, hybrid_times_1st_lick_reward, hybrid_times_1st_late_lick], 1000);
hold on
plot([0,0], [0, 100], 'g-'); 
